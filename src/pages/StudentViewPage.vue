...
import { auth, googleProvider } from 'src/services/firebase/config';
...
import { surveyApiService } from 'src/services/api/surveyApiService';
import type { SurveyData } from 'src/types/survey';
