      ...
      <div v-if="!isPresentationMode" class="editor-mode-notice">
        <q-banner class="bg-orange text-white" rounded>
          ...
          <div class="text-body2">
            ...
            현재 편집기 모드입니다. 프레젠테이션 모드로 전환하려면 상단의 편집 버튼을 클릭하거나 ESC
            키를 누르세요.
          </div>
        </q-banner>
      </div>
...
const slideViewerStyle = computed(() =>
  !isPresentationMode ? { flex: `0 0 ${slideViewerWidth.value}%` } : {},
);
const editorStyle = computed(() =>
  !isPresentationMode ? { flex: `0 0 ${editorWidth.value}%` } : {},
);
