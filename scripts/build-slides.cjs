  ...
  if (type === 'cover') {
    ...
    typeSpecificCSS = `
          ...
          h1 {
              ...
              font-weight: 800;
              margin-bottom: 10px;
              text-shadow: 3px 3px 12px rgba(0,0,0,0.5), 1px 1px 4px rgba(0,0,0,0.3);
          ...
          h2 {
              ...
              margin-bottom: 10px;
              color: #ffffff;
              text-shadow: 2px 2px 8px rgba(0,0,0,0.4), 1px 1px 3px rgba(0,0,0,0.2);
              animation: fadeInUp 1.2s ease .3s both;
          }
          h3 {
              font-size: 2rem;
              font-weight: 500;
              ...
              animation: fadeInUp 1.2s ease .6s both;
          }
